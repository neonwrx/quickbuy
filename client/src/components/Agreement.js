  ...
  return (
    <div>
      ...
      <div className="agreement container">
        ...
        <p>6.1.3. Отправить пакет документов, упомянутых в положениях п.п. 6.1.1., 6.1.2. настоящего Соглашения, на электронный почтовый ящик СРА-сети(кликните, для открытия формы обратной связи).
        </p>
